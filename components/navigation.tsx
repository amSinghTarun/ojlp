          ...
          <div className="hidden md:flex items-center">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button className="transition-all duration-200 bg-primary hover:bg-primary/90 flex items-center gap-1 rounded-full px-5">
          ...
          <div className="md:hidden">
            <Sheet>
              ...
              <SheetContent side="right" className="w-[85vw] sm:w-[350px] pr-0">
                ...
                <nav className="grid gap-6 text-lg font-medium pr-6">
                  <Link
                    href="/"
                    className={cn(
                  ...
                  <div className="grid gap-3 pl-3 mt-2">
                    <h3 className="text-foreground font-semibold">Submit</h3>
                    {submitLinks.map((link) => (
                      <Link
                        key={link.href}
                        href={link.href}
