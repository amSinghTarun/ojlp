...
import { getUsers, getUserById, updateUserPermissions } from "@/lib/auth"
...
export function PermissionsManager() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Filter out super admins as they have all permissions by default
        const filteredUsers = userData.filter((user) => user.role !== "SUPER_ADMIN")
  ...
  if (loading) {
    return <div>Loading permissions manager...</div>
  }
