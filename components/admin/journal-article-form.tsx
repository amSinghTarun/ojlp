...
const formSchema = z.object({
  ...
  authorSlug: z
    .string()
    .min(2, {
      message: "Author slug must be at least 2 characters.",
    })
    .regex(/^[a-z0-9]+(?:-[a-z0-9]+)*$/, {
      message: "Author slug must contain only lowercase letters, numbers, and hyphens.",
    }),
...
export function JournalArticleForm({ article }: JournalArticleFormProps) {
  ...
  const [selectedAuthor, setSelectedAuthor] = useState<Author | null>(
    article ? { name: article.author, slug: article.authorSlug, email: "" } : null,
  )
  ...
  const categories = [
    ...
    { value: "legal-history", label: "Legal History" },
  ]
                    ...
                    <div>
                      <AuthorSelector
                        ...
                        onSelect={(author) => {
                          ...
                          form.setValue("authorSlug", author.slug)
                        }}
                      />
                      <Input type="hidden" {...field} />
                    </div>
                  </FormControl>
                  <FormDescription>Select an existing author or create a new one.</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
              ...
              render={() => (
                <FormItem>
                  <div className="mb-4">
                    ...
                    <FormDescription>Select the categories that apply to this article.</FormDescription>
                  </div>
